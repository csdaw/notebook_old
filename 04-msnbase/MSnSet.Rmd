...
### featureData (optional)

Contains metadata about the features (e.g. proteins, peptides, PSMs). For 
example for protein features this object might contain the protein names, 
...
Contains metadata about each sample, usually relating to the experimental 
design, e.g. replicates, tissues, animals, treatments, etc.
...
Contains equipment-generated information about the protocols used for each
samples. The number of rows and the row names must match the number of columns
...
### experimentData (optional)

Contains descriptive information about the experiment and the experimenter.
